    ...
    <section className="mx-auto max-w-xl">
      <div className="panel">
        ...
        <p className="mt-3 text-base leading-7 text-[var(--muted)]">
          Cadastre-se para salvar equipes, editar os detalhes do seu time e manter tudo vinculado ao seu usuário.
        </p>
        ...
        <p className="mt-6 text-sm text-[var(--muted)]">
          Já possui conta? <Link href="/login" className="font-semibold text-[var(--brand)]">Entrar</Link>
        </p>
      </div>
    </section>
  );
